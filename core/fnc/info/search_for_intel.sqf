...
[btc_int_search_intel_time, [_target, player, _radius], {[_this, "btc_fnc_info_has_intel"] remoteExec ["call", 2]}, {}, _localizedTitle, _condition, ["isnotinside"]] call ace_common_fnc_progressBar;
